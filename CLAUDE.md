# Mörk Borg — Claude Cowork Instructions
...
All PDFs in this project are canon. Do not contradict them.
When expanding, extrapolate from established tone and lore.
If uncertain whether something fits, err toward darker and stranger.
...
- Lore delivered in fragments, not exposition
...
When building the wiki from source PDFs:

1. Extract all named locations, factions, creatures, items, NPCs
2. Organize into markdown files by category
3. Cross-reference with [[wiki links]] so everything connects
4. Note page references to source material
...
[2-3 sentences of lore in Mörk Borg voice]

**Connections:** [[related entry]], [[related entry]]

**Gaps/Expansion Notes:** what's left undefined that could be developed
...
- Flavor text of 2-4 sentences maximum
...
**Lore:** [2-4 sentences, bleak, fragmented, wrong]
...
- The expansion should feel like it was always there

## Random Table Format

All tables use d6 unless otherwise specified.
Each entry should feel like it belongs in the same dying world.
Tables should be immediately usable at the table.
